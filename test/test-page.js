import '/test/archive-resources-test.js';
import '/test/better-fetch-tests.js';
import '/test/coerce-element-test.js';
import '/test/color-contrast-filter-test.js';
import '/test/color-test.js';
import '/test/count-resources-test.js';
import '/test/create-resource-test.js';
import '/test/delete-resource-test.js';
import '/test/dom-filter-tests.js';
import '/test/export-opml-test.js';
import '/test/favicon-tests.js';
import '/test/feed-parser-test.js';
import '/test/fetch-html-test.js';
import '/test/fetch-image-element-test.js';
import '/test/filter-publisher-test.js';
import '/test/filter-unprintables-tests.js';
import '/test/get-path-extension-test.js';
import '/test/get-resource-test.js';
import '/test/get-resources-test.js';
import '/test/image-dimensions-filter-tests.js';
import '/test/import-entry-tests.js';
import '/test/import-opml-test.js';
import '/test/indexeddb-utils-test.js';
import '/test/migrations-tests.js';
import '/test/mime-utils-test.js';
import '/test/patch-resource-test.js';
import '/test/put-resource-test.js';
import '/test/remove-html-test.js';
import '/test/resource-utils-tests.js';
import '/test/set-base-uri-test.js';
import '/test/subscribe-test.js';
import '/test/truncate-html-tests.js';
import '/test/unwrap-element-tests.js';
import '/test/url-sniffer-test.js';

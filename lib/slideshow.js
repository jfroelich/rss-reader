...
function showNextSlide() {
  console.log('preparing to show next slides');

  if(countUnreadSlides() < 2) {
    console.log('less than 2, calling append');
    appendSlides(function() {
        console.log('finished appending, now cleaning up');
  ...
  function showNext() {
    console.log('actually showing next');

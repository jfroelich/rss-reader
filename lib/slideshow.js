...
slideshow.appendSlide = function(entry, isFirst) {
  ...
  var contentHTMLDocument = util.parseHTML(entry.content || '');

  sanitizer.sanitize(entry.link, contentHTMLDocument);
  trimming.trimDocument(contentHTMLDocument);
  
  content.innerHTML = contentHTMLDocument.innerHTML;

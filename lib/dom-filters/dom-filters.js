...
export async function applyAllDOMFilters(doc, options = {}) {
  ...
  transformFrameRelatedElements(doc, options.emptyFrameBodyMessage);
...
export function transformFrameRelatedElements(doc, defaultMessage = 'Framed content not supported') {
...
export function unwrapSingleItemListElements(doc) {

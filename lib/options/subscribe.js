...
function onFeedUnsubscribedMessage(event) {
  if(event.type != 'unsubscribe') return;

  var ELEMENT_MANAGE_FEEDS_LIST = document.getElementById('feedlist');
  var ELEMENT_NO_SUBSCRIPTIONS = document.getElementById('nosubscriptions');
...
chrome.runtime.onMessage.addListener(onFeedUnsubscribedMessage);

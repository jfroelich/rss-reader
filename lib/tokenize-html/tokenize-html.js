    ...
    switch(state) {
      ...
      case STATE_TAG_OPEN:
        ...
        if(cursor === '>') {
          ...
          // is a space it is not valid.
          // Possibly an unencoded < in plain text
          console.warn('Unrecognized tag name at character "%s"', cursor,
      ...
      case STATE_SCRIPT_SINGLE_LINE_COMMENT:
        ...
        // It would make sense at first to also check if at EOF because
        // EOF is a valid terminator in the context of a js single line
        // comment, but actually, that would mean the content ended amidst
        // a script tag, which is malformed.

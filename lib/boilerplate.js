...
export function classify(dataset, scoreBlock, options = {}) {
  ...
  const documentArea = isNaN(options.documentArea) ? defaultDocumentArea
    : options.documentArea;
  ...
  let minimumContentThreshold = isNaN(options.minimumContentThreshold) ? defaultMinimumContentThreshold : options.minimumContentThreshold;
...
// TODO: scoreBlock should not be a

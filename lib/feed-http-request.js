...
FeedHttpRequest.prototype.parseXMLFeed = function(xmlDocument) {
  ...
  var fetchEntry = function(entry) {
    ...
    request.onload = function(event) {
      ...
      // This is definitely happening. For example, SCOTUS blog
      // entry.link URLs point to PDF documents. responseText
      // on chrome stores a message in responseText about 
      // DLLs and other scary things, and this is what the user 
      // ends up seeing. Not good.

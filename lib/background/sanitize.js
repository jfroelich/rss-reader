// TODO: fix bug with stripping whitespace around anchors and similar
// inline elements (well at least anchors).
...
// TODO: Improve removal of javascript: links. startsWith is too simple.
// Since we do not allow inline scripts this does not really matter.

// TODO: consider removing width/height URL parameters in img.src. Requires
// new URI.js code that handles parameters properly.

// TODO: consider Google CAJA style attributes per element instead of a 
// global list allowed attributes
...
sanitizer.scrubAnchor = function(node) {
  ...
  // Remove javascript:
  if(strings.startsWith(href.toLowerCase(), 'javascript:')) {
...
sanitizer.scrubAttributes = function(node) {
  ...
  // Now remove the attributes after iteration which avoids the 
  // problem with mutation during iteration.
...
// Attributes whether the presence or value of values is irrelevant

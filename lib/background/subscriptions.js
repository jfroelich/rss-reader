 ...
 *
 * TODO: polling and update are working again, need to fix/test
 * import, add, remove
 *
...
subscriptions.add ....
  var context = new subscriptions.PutContext();
  context.setprops..
...
subscriptions.PutContext = function(){};
subscriptions.PutContext.prototype.checkExists =...

etc.

But note, for the async sections I still think those params 
should be passed around as function args

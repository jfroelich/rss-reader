...
function entryLinkClicked(event) {  
  ...
  // Get the containing entry element
  // NOTE: this is a sign i am attaching a listener to the wrong thing.
  ...
  // NOTE: this is also a sign i am listening on the wrong thing
  // since the click listener on the div should be removed at this point.
  ...
  // NOTE: this is also a sign I am listening on the wrong thing since
  // I want an attribute of the containing div.

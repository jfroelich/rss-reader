...
var ELEMENT_BLACKLIST_SELECTOR = 'applet,base,basefont,button,command,datalist,'+
...
NON_TEXT_CONTAINER = {
  audio:1,embed:1,img:1,iframe:1,object:1,video:1,canvas:1
  },
...
UNWRAPPABLE = {
  center:1,div:1,font:1,form:1,html:1,legend:1,span:1
};
...
function transformDocument(doc, options) {
  ...
  each(doc.body.querySelectorAll(ELEMENT_BLACKLIST_SELECTOR), removeNode);

...
function testPollingService() {
  ...
  pollService.log.level = LoggingService.LEVEL_OFF;
  ...
  pollService.urlRewritingService.log.level = LoggingService.LEVEL_OFF;
  pollService.fetchHTMLService.log.level = LoggingService.LEVEL_DEBUG;
  pollService.fetchHTMLService.imageDimensionsService.log.level =
    LoggingService.LEVEL_OFF;
  pollService.start();
}

...
view, a mime-type value is a specialized form of a string. Therefore, there is
no explicit data type, just helpers that work with strings that purport to be
mime types.
...
The current values are rather arbitrary. They provide some bounds to allow for
early exits during parsing and to quickly check validity based on length.
...
# TODO: document and record that law I came across about tolerating sloppy input
but producing nice output and cite as a design philosophy, postel's law?

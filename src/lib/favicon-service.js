...
// ### TODOs
// * Once url-loader is a library in the lib folder, this should also become a
// lib, and maybe I should make lookup-icon operation (and ops like
// compact-favicons) too, only interact with the favicon-service lib through
// those operations instead of directly in other parts of the app. Because
// url-loader is not currently a lib, and my general rule is that libs cannot
// depend on app components (only other lib components), this has to wait.

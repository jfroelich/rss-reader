...
// The notification click handler needs to check if the Chrome window is
// currently open before trying to show a tab, otherwise Chrome crashes. This
// was present in Chrome 55 on Mac. I want to test if this behavior is no longer
// needed.

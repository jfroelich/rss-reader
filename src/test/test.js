import '/src/test/archive-entries-test.js';
import '/src/test/subscribe-test.js';
import '/src/test/color-test.js';
import '/src/test/model-access-test.js';
import '/src/test/model-test.js';
import '/src/test/coerce-element-test.js';
import '/src/test/html-document-test.js';
import '/src/test/favicon-service-test.js';
import '/src/test/boilerplate-test.js';
import '/src/test/color-contrast-filter-test.js';
import '/src/test/empty-attribute-filter-test.js';
import '/src/test/filter-lazy-images-test.js';
import '/src/test/set-image-sizes-test.js';
import '/src/test/html-test.js';
import '/src/test/indexeddb-test.js';
import '/src/test/string-test.js';
import '/src/test/fetch-feed-test.js';
import '/src/test/fetch-html-test.js';
import '/src/test/fetch2-test.js';
import '/src/test/mime-test.js';
import '/src/test/sniff-test.js';
import '/src/test/nlp-test.js';
import '/src/test/import-opml-test.js';
import '/src/test/parse-feed-test.js';
import '/src/test/rewrite-url-test.js';

...
import {entry_id_is_valid, entry_is_valid, entry_sanitize, ENTRY_STATE_UNARCHIVED, ENTRY_STATE_UNREAD, is_entry} from '/src/objects/entry.js';
...
function executor(entry, validate, resolve, reject) {
  ...
  const is_create = !entry_id_is_valid(storable_entry.id);
  let storable_entry;

...
export default function getResource(conn, query) {
  return new Promise(getResourceExecutor.bind(this, conn, query));
}

function getResourceExecutor(conn, query, resolve, reject) {

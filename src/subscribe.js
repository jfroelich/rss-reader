...
* **console** {object} a logging destination, any console-like object including
the builtin console, required, consider using console-stub to call non-verbose
...
* **skip_icon_lookup** {Boolean} whether to skip the favicon lookup for the new
feed, defaults to false, useful to speed up the operation
...
* I have mixed feelings about treating already-subscribed as an error. It isn't
a programming error. But the subscribe in some sense failed. Right now this
returns undefined. But maybe it should be an error. Or maybe I need a more
complicated type of return value. Just returning undefined does not really
clarify things. I am not sure callers expect it, and not sure I like this
approach.

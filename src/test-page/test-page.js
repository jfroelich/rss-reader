import * as rewrite_url_tests from '/src/rewrite-rules/rewrite-rules-tests.js';
import * as array_utils_tests from '/src/array-utils/array-utils-tests.js';
import {coerce_element_test} from '/src/coerce-element/coerce-element-test.js';
import * as color_contrast_filter_tests from '/src/color-contrast-filter/color-contrast-filter-test.js';
...
import {parse_feed_test} from '/src/feed-parser/feed-parser-test.js';
import {fetch_html_test} from '/src/fetch-html/fetch-html-test.js';
import {fetch_image_element_test} from '/src/fetch-image-element/fetch-image-element-test.js';
import {fetch_image_test} from '/src/fetch-image/fetch-image-test.js';
import {filter_publisher_test} from '/src/filter-publisher/filter-publisher-test.js';
import * as html_utils_tests from '/src/html-utils/html-utils-tests.js';
import * as image_size_filter_tests from '/src/image-dimensions-filter/image-dimensions-filter-tests.js';
import * as idb_tests from '/src/indexeddb-utils/indexeddb-utils-test.js';
import {legible_text_filter_test} from '/src/legible-text-filter/legible-text-filter-test.js';
import {mime_test} from '/src/mime/mime-test.js';
import * as net_tests from '/src/net/net-tests.js';
import * as set_base_uri_tests from '/src/set-base-uri/set-base-uri-tests.js';
import {sniffer_test} from '/src/sniffer/sniffer-test.js';
import * as string_utils_tests from '/src/string-utils/string-utils-tests.js';
import * as unwrap_element_tests from '/src/unwrap-element/unwrap-element-tests.js';

// TODO: if this module is only in use by one other module, then this should not
// be a global module, instead this should just be a helper module file located
// within that other module's folder

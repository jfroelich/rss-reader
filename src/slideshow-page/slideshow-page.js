...
import download_xml_document from '/src/slideshow-page/download-xml-document.js';
import * as favicon from '/src/favicon/favicon.js';
import filter_publisher from '/src/slideshow-page/filter-publisher.js';
import format_date from '/src/slideshow-page/format-date.js';
import export_opml from '/src/slideshow-page/export-opml.js';

...
this.classifyBoilerplate = classifyBoilerplate;
...
const DIV_IDS = new Set([
  ...
  'leader', // hostilefork
  'lfs-popup', // priceonomics.com
  'livefyre-wrapper', // The Wall Street Journal
  'logo-branding', // priceonomics.com
  ...
  'right-islands', // priceonomics.com
  'rn-section', // Getty
  'rt_contact', // CNBC
...
const DIV_CLASSES = [
  ...
  'content-extra', // priceonomics.com
  ...
  'popular-posts', // priceonomics.com
...
const ANCHOR_CLASSES = [
  ...
  'enlargebtn', // NPR
  'event-after-article', // techcrunch.com
